...
export default class Whiteboard extends React.Component {
  ...
  rewind = () => {
    ...
    this.setState({
      ...
      this._onChangeStrokes([...strokes],this.state.strikes);
    });
  };
  ...
  clear = () => {
    this.setState({
      ...
      this._onChangeStrokes([],this.state.strikes);
    });
      ...
      checkLine =()=>{
        //if(this.state.previousStrokes.length>1){
           ...
           for(k=0;k<currCoords.length-1;k++){
              ...
              if(k>0){//check for self-loop
                 for(let m=0;m<k;m++){
                    let prevX=currCoords[m].split(",")[0];
                    let prevY=currCoords[m].split(",")[1];
                    let prevX2=currCoords[m+1].split(",")[0];
                    let prevY2=currCoords[m+1].split(",")[1];
                    if(this.intersects(currX,currY,nextX,nextY,prevX,prevY,prevX2,prevY2)){
                       this.setState({strikes:this.state.strikes+1});
                       return true;
                    }
               }
  ...
  onResponderRelease() {
    ...
    this.setState({
      ...
      this._onChangeStrokes(this.state.previousStrokes,this.state.strikes);
   ...
   _onChangeStrokes = (strokes,strikes) => {
      if(this.props.onChangeStrokes){
        this.props.onChangeStrokes(strokes,strikes);
      }
   }
